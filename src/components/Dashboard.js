...
function Dashboard() {
    const [username] = useState(localStorage.getItem('authUser') || 'User');
    ...
    return (
        <div className='flex flex-col gap-7'>
            ...
            <div className='flex border-t border-t-gray-300 min-h-screen'>
                <div className='flex flex-col gap-7 w-20 border-r border-t-gray-300 p-6 mt-5'>
                    <FontAwesomeIcon icon={faHome} className="text-gray-600 cursor-pointer" size="lg" onClick={() => navigate('/dashboard/home')} />
                    <FontAwesomeIcon icon={faBriefcase} className="text-gray-600 cursor-pointer" size="lg" onClick={() => navigate('/dashboard/jobpost')} />
                </div>
                <Routes>
